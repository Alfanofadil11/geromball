...
export const metadata: Metadata = {
  title: 'Basya - Arsenal KOL Indonesia | GEROMBALL',
  description: 'Basya, Arsenal KOL di Indonesia. Fan Arsenal yang membawa banter dan fandom football ke level berikutnya.',
  openGraph: {
    title: 'Basya - Arsenal KOL Indonesia | GEROMBALL',
    description: 'Arsenal KOL di Indonesia. Fan Arsenal yang membawa banter dan fandom football ke level berikutnya.',
    url: 'https://geromball.com/talent/basya',
  },
  alternates: { canonical: 'https://geromball.com/talent/basya' },
}
...
export default function BasyaPage() {
  const personSchema = {
    ...
    url: 'https://geromball.com/talent/basya',
    image: 'https://geromball.com/talent/Basyaknowsball.JPG',
    ...
    sameAs: ['https://instagram.com/basyaknowsball'],
  }
        ...
        <section className="mx-auto max-w-4xl px-6">
          <div className="mb-12 flex flex-col items-center gap-8 md:flex-row">
            <div className="h-48 w-48 flex-none overflow-hidden rounded-2xl">
              <img src="/talent/Basyaknowsball.JPG" alt="Basya" className="h-full w-full object-cover object-top" />
            </div>
            <div className="text-center md:text-left">
              <h1 className="heading-display mb-2 text-4xl font-bold uppercase tracking-wider md:text-5xl">Basya</h1>
          ...
          <div className="mb-12 rounded-2xl border border-foreground/20 bg-card p-8">
            <h2 className="heading-display mb-4 text-2xl font-bold uppercase tracking-wider">Tentang Basya</h2>
            <p className="mb-4 text-lg leading-relaxed text-muted">
              Basya adalah <strong className="text-foreground">Arsenal KOL</strong> yang membawa perspektif unik sebagai fan dari klub legendaris ini.
            </p>
            <p className="text-lg leading-relaxed text-muted">
              Sebagai bagian dari <strong className="text-foreground">GEROMBALL</strong>, Basya berkontribusi dalam program-program unggulan dengan takes yang tajam dan autentik.
            </p>
          </div>

          <div className="mb-12 grid gap-4 grid-cols-3">
            <div className="rounded-xl border border-card-border bg-card p-6 text-center">
              <div className="heading-display text-3xl font-bold gradient-text">17K+</div>
          ...
          <div className="mb-12 rounded-2xl border border-foreground/20 bg-card p-8">
            <h2 className="heading-display mb-4 text-2xl font-bold uppercase tracking-wider">Yang Dibahas Basya</h2>
          ...
          <div className="mb-12 rounded-2xl border border-foreground/20 bg-card p-8">
            <h2 className="heading-display mb-4 text-2xl font-bold uppercase tracking-wider">Ikuti Basya</h2>
          ...
          <div className="rounded-2xl border border-foreground/20 bg-card p-12 text-center">
            ...
            <p className="mx-auto mb-8 max-w-xl text-muted">Hubungi GEROMBALL untuk kolaborasi dengan Basya.</p>
