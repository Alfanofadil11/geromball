...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'KOL Sepakbola Indonesia | GEROMBALL',
    description: 'KOL Sepakbola Indonesia adalah figur berpengaruh di dunia sepak bola. Daftar lengkap KOL bola Indonesia.',
